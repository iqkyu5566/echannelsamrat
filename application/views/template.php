...
<html lang="en" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>BRI Kendari Samratulangi - Echannel & IT</title>
        <!-- start: META -->
        <meta charset="utf-8" />
        ...
        <!-- end: META -->
        <!-- start: MAIN CSS -->
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/fonts/style.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/css/main.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/css/main-responsive.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/iCheck/skins/all.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/bootstrap-colorpalette/css/bootstrap-colorpalette.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/perfect-scrollbar/src/perfect-scrollbar.css">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/css/theme_light.css" type="text/css" id="skin_color">
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/css/print.css" type="text/css" media="print"/>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css">
...
<!--                             <div id="style_selector" class="hidden-xs close-style">
        ...
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jQuery-lib/2.0.3/jquery.min.js"></script>
        <!--<![endif]-->
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/blockUI/jquery.blockUI.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/iCheck/jquery.icheck.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/perfect-scrollbar/src/jquery.mousewheel.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/perfect-scrollbar/src/perfect-scrollbar.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/less/less-1.5.0.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jquery-cookie/jquery.cookie.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/js/main.js"></script>
        <!-- end: MAIN JAVASCRIPTS -->
        <!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/flot/jquery.flot.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/flot/jquery.flot.pie.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/flot/jquery.flot.resize.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jquery.sparkline/jquery.sparkline.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/plugins/fullcalendar/fullcalendar/fullcalendar.js"></script>
        <script src="<?php echo base_url() ?>assets/admin/clip-one/assets/js/index.js"></script>
