...
class Tbl_kaset_atm extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Tbl_kaset_atm_model');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $tbl_kaset_atm = $this->Tbl_kaset_atm_model->get_all();

        $data = array(
            'tbl_kaset_atm_data' => $tbl_kaset_atm
        );
    ...
    {
        $row = $this->Tbl_kaset_atm_model->get_by_id($id);
        if ($row) {
            $data = array(
		...
		'keterangan' => $row->keterangan,
            ...
            redirect(site_url('tbl_kaset_atm'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('tbl_kaset_atm/create_action'),
    ...
    public function create_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Tbl_kaset_atm_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('tbl_kaset_atm/update_action'),
    ...
    public function update_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Tbl_kaset_atm_model->update($this->input->post('id_kaset_atm', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Tbl_kaset_atm_model->delete($id);
	...
	foreach ($this->Tbl_kaset_atm_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'tbl_kaset_atm_data' => $this->Tbl_kaset_atm_model->get_all(),
            'start' => 0
        );
...
/* End of file Tbl_kaset_atm.php */
/* Location: ./application/controllers/Tbl_kaset_atm.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2017-03-16 02:43:55 */
/* http://harviacode.com */